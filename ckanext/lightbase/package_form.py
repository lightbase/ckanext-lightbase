...
# Setup the fieldset
def build_lightbase_form(is_admin=False,
...
def get_lightbase_fieldset(is_admin=False, user_editable_groups=None, **kwargs):
    return build_lightbase_form(is_admin=is_admin,
                              user_editable_groups=user_editable_groups,
                              **kwargs).get_fieldset()

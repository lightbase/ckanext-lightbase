...
class lightbaseGroupForm(SingletonPlugin):
...
class lightbaseDatasetForm(SingletonPlugin, ckan.lib.plugins.DefaultDatasetForm):
    ...
    def setup_template_variables(self, context, data_dict=None):
        ...
        c.publishers = [('lightbase publisher', 'lightbase publisher 2')]
